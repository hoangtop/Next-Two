...
smartTvKeyboardLayouts.enBoxed = {
    unshift: [
        ...
        [
            ...
            { text: 'Back', value: '&&back', length: 4, color: 'warning' },
        ...
        // ],
        [
            { text: 'Quay lại', value: '&&previous', length: 4, color: 'success' },
            { text: 'Tiếp theo', value: '&&next', length: 4, color: 'success' }
        ]
    ],
    shift: [
        [
    ...
    sym: [
        ...
        [
            { text: '', value: null, length: 1, color: 'symbol' },
            { text: '', value: null, length: 1, color: 'symbol' },
            { text: '', value: null, length: 1, color: 'symbol' },
            { text: '', value: null, length: 1, color: 'symbol' },
            { text: '', value: null, length: 1, color: 'symbol' },
